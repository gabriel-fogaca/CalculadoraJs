...
function handleBtnTimesClick(event) {
    ...
    const product = Number(inputNumber1.value.replace(",", ".")) * Number(inputNumber2.value.replace(",", "."));
    handleResultChange(product);
}
